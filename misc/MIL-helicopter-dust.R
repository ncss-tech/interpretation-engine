...
idx <- grep('dust', rules$rulename, ignore.case = TRUE)
rules$rulename[idx]
...
y <- rules[rules$rulename == 'MIL - Helicopter Dusty', ]
...
ee <- dt$RuleHedge_2d240e7a$RuleHedge_2d843d3e$`EPM - USDA Surface - SIL/SI/VFSL/L`
