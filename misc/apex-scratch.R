...
# )
# 
# my_data$GRL.USDA.TEXTURE.MODIFIER.SURFACE.LAYER <- ifelse(
#   is.na(my_data$GRL.USDA.TEXTURE.MODIFIER.SURFACE.LAYER),
#   NA,
#   my_data$GRL.USDA.TEXTURE.MODIFIER.SURFACE.LAYER
# )
...
interpret(r, my_data)
r2 <- r$RuleOperator_3886708d$children[[7]]
r2 |> interpret(my_data, cache = TRUE)
r2$RuleOperator_c5e1ae36$children[[1]]$RuleOperator_1257f912$children[[1]] |> interpret(my_data)
